...
static void config_load()
{
	...
	else
	{
		...
		option.config_buttons[6] = 304;
		option.config_buttons[7] = 32;
...
void Menu()
{
    ...
    while (((currentselection != 1) && (currentselection != 6)) || (!pressed))
    {
		...
		print_string("VecxEmu - Date: " __DATE__, TextWhite, 0, 5, 15, backbuffer->pixels);
        ...
        if (currentselection == 4)
        {
			...
			{
				case 0:
					print_string("Rotate : No", TextRed, 0, 5, 105, backbuffer->pixels);
				break;
				case 1:
					print_string("Rotate : Yes (Counter-wise)", TextRed, 0, 5, 105, backbuffer->pixels);
				break;
				case 2:
					print_string("Rotate : Yes (Clockwise)", TextRed, 0, 5, 105, backbuffer->pixels);
				break;
			}
        }
        else
        {
			...
			{
				case 0:
					print_string("Rotate : No", TextWhite, 0, 5, 105, backbuffer->pixels);
				break;
				case 1:
					print_string("Rotate : Yes (Counter-wise)", TextWhite, 0, 5, 105, backbuffer->pixels);
				break;
				case 2:
					print_string("Rotate : Yes (Clockwise)", TextWhite, 0, 5, 105, backbuffer->pixels);
				break;
			}
        }
		...
		print_string("Credits: Valavan, Hawthorn, Nikita", TextWhite, 0, 5, 225, backbuffer->pixels);
...
{
	snprintf(home_path, sizeof(home_path), "%s/.vecxemu", getenv("HOME"));
